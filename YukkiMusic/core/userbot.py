...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("FHT7P")
                await self.one.join_chat("FHT7P")
                await self.one.join_chat("FHT7P")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("FHT7P")
                await self.two.join_chat("FHT7P")
                await self.two.join_chat("FHT7P")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("FHT7P")
                await self.three.join_chat("FHT7P")
                await self.three.join_chat("FHT7P")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("FHT7P")
                await self.four.join_chat("FHT7P")
                await self.four.join_chat("FHT7P")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("FHT7P")
                await self.five.join_chat("FHT7P")
                await self.five.join_chat("FHT7P")
            except:
                pass
